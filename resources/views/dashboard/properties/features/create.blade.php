		        ...
		        <div class="row">
		            <div class="col-md-12 col-sm-12 ">
		                <div class="x_panel">
		                    ...
		                    <div class="x_content">
		                        <br />
		                        <form class="form" action="{{route('admin.properties.features.store')}}" method="POST" enctype="multipart/form-data">
		                            @csrf
		                                        ...
		                                        <div class="row">
		                                            <div class="col-md-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <input type="number" id="area" class="form-control" placeholder="  " value="{{old('area')}}" name="area">
		                                                    @error("area")
		                                            ...
		                                            <div class="col-md-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <input type="number" id="rooms" class="form-control" placeholder="  " value="{{old('rooms')}}" name="rooms">
		                                                    @error("rooms")
		                                                    <span class="text-danger">{{$message}}</span>
		                                                    @enderror
		                                                </div>
		                                            ...
		                                            <div class="col-md-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <input type="number" id="bedrooms" class="form-control" placeholder="  " value="{{old('bedrooms')}}" name="bedrooms">
		                                                    @error("bedrooms")
		                                                    <span class="text-danger">{{$message}}</span>
		                                                    @enderror
		                                                </div>
		                                            ...
		                                            <div class="col-md-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <input type="number" id="bathrooms" class="form-control" placeholder="  " value="{{old('bathrooms')}}" name="bathrooms">
		                                                    @error("bathrooms")
		                                                    <span class="text-danger">{{$message}}</span>
		                                                    @enderror
		                                                </div>
