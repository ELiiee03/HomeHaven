		        ...
		        <div class="row">
		            <div class="col-md-12 col-sm-12 ">
		                <div class="x_panel">
		                    ...
		                    <form class="form" action="{{route('admin.sliders.images.store.db')}}" method="POST" enctype="multipart/form-data">
		                        @csrf
		                                        ...
		                                        <div class="row">
		                                            ...
		                                            <figure class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">
		                                                <a href="{{$image -> photo}}" itemprop="contentUrl" data-size="480x360">
		                                                    <img class="img-thumbnail img-fluid" src="{{$image -> photo}}" itemprop="thumbnail" alt="Image description">
		                                                </a>
		                                            </figure>
		                                            @empty
